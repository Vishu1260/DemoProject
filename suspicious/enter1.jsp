...
<link rel="stylesheet" type="text/css" href="images/cour.css" >-->
  ...
  <form method="POST" name="form"  action="addwords.jsp?user=<%=request.getParameter("user")%>">
<body topmargin="0">
<table border="0"  height="19">
		...
		<td width="2%" height="100" valign="top">
              ...
              Manage Keywords</a></b></div>
					...
					<tr align="center"><td align="center"><input type="submit" name="ADD" value="ADD" align="center">
